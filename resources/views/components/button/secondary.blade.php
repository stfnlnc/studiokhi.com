...
@php
    $classes = 'group select-none lg:flex  cursor-pointer flex-row border-b border-sk-' . $mode . ' bg-transparent py-[0.3rem] text-body-base text-sk-' . $mode . ' transition-colors duration-300 hover:border-sk-grey hover:text-sk-grey ';

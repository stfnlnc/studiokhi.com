...
>
    <div class="grid grid-cols-3 gap-14">
        <div class="flex flex-col text-sk-light">
            <span>01</span>
            <x-button.secondary full icon mode="light">Branding & <br/> Direction Artistique</x-button.secondary>
        ...
        <div class="flex flex-col text-sk-light">
            <span>02</span>
            <x-button.secondary full icon mode="light">Webdesign & <br/> Design Digital</x-button.secondary>
            <ul class="mt-6 text-sk-grey">
                <li>Webdesign</li>
                <li>UX/UI Design</li>
                <li>Wireframe</li>
        ...
        <div class="flex flex-col text-sk-light">
            <span>03</span>
            <x-button.secondary full icon mode="light">Développement Web & <br/> Sites Sur Mesure</x-button.secondary>
            <ul class="mt-6 text-sk-grey">
                <li>Site Vitrine</li>

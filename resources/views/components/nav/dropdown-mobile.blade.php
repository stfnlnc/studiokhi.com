...
>
    ...
    <div class="flex flex-col gap-2 mt-2 mb-6 ml-4">
        <x-nav.link class="text-sk-light h4" :current="str_contains($route, 'app.service.')" mode="dark"
                    underline>
            Services
        </x-nav.link>
        ...
        <x-button.secondary class="link-loader ml-8" href="{{ route('app.service.website') }}" full icon mode="light">Développement Web & <br/>
            Sites
            Sur Mesure
        </x-button.secondary>
    </div>
    <span class="w-full border-t border-sk-dark-grey"></span>
    <x-nav.link class="link-loader w-full text-sk-light h4 my-2 ml-4" :current="$route === 'app.work'"
                :href="route('app.work')"
                mode="dark"
    ...
    <span class="w-full border-t border-sk-dark-grey"></span>
    <x-nav.link class="link-loader text-sk-light h4 my-2 ml-4" :current="$route === 'app.posts'"

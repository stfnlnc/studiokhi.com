...
@section('content')
    <section id="hero"
             class="relative z-10 flex w-full flex-col gap-20 border-b px-4 py-36 h-[100lvh] bg-sk-blue text-sk-dark border-sk-light-grey lg:px-8 lg:py-48 xl:px-16">
        <h1>Branding & <br>
    ...
    <section
        class="relative z-10 flex w-full flex-col lg:flex-row justify-start gap-8 px-4 py-24 bg-sk-blue lg:px-8 xl:px-16 text-center lg:text-left">

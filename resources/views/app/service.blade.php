...
@section('content')
    ...
    <section
        class="relative z-10 flex w-full flex-col items-center gap-16 px-4 py-24 bg-sk-{{ $color }} lg:px-8 xl:px-16 text-center -mt-2">
        <div class="h2 w-full lg:w-2/3">Prêts à nous partager votre projet ?</div>
        <x-button.primary mode="darker" target="_blank" :href="config('app.calendly')" icon>Réservez votre appel découverte</x-button.primary>
    </section>
@endsection
